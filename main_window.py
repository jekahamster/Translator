...
class MainWindow(QtWidgets.QMainWindow):
    ...
    HOTKEYS = HotKeys(os.path.join(ROOT_DIR, "config/hotkeys.json"))
    ...
    def __init__(self):
        ...
        try:
            ...
            self.audio_engine.setProperty('voice', voices[MainWindow.SETTINGS["audio_voice"]].id)
            self.audio_engine.setProperty('rate', MainWindow.SETTINGS["audio_rate"])
    ...
    def set_up_shortcuts(self):
        self.shortcut_swap = QtWidgets.QShortcut(QtGui.QKeySequence(MainWindow.HOTKEYS.swap_lang), self)
        self.shortcut_sound_src = QtWidgets.QShortcut(QtGui.QKeySequence(MainWindow.HOTKEYS.listen_src), self)
        self.shortcut_sound_dst = QtWidgets.QShortcut(QtGui.QKeySequence(MainWindow.HOTKEYS.listen_dst), self)
        self.shortcut_translate = QtWidgets.QShortcut(self.tr(MainWindow.HOTKEYS.translate_from_text_area), self.ui.originalTextField)
        self.shortcut_add_to_favorite = QtWidgets.QShortcut(QtGui.QKeySequence(MainWindow.HOTKEYS.add_to_favorite), self)
        self.tt.translate_from_clipboard_hotkey = MainWindow.HOTKEYS.translate_from_clipboard
        self.tt.translate_from_screenshot_hotkey = MainWindow.HOTKEYS.translate_from_screenshot

        self.tt.translation_loading_signal.connect(self.prepare_translatoin_loading_signal)
    ...
    def prepare_translatoin_loading_signal(self):
